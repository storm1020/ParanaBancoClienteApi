...
namespace ParanaBancoClienteApi.Controllers
{
    ...
    public class ClienteController : Controller
    {
        ...
        /// <response code="200">Retorna lista contendo todos os clientes cadastrados.</response>
        [HttpGet]
        ...
        [HttpGet("cliente/{ddd},{numeroTelefone}")]
        ...
        [HttpPut("cliente/{idCliente},{email}")]
        ...
        [HttpPut("clienteTelefone/{telefoneAntigo},{telefoneNovo}")]
